...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        self.decay = 0.003       # Decay factor for epsilon
        self.trial_cnt = 0       # trial number
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            #self.epsilon -= 0.05
            #self.epsilon = self.decay**total_trial
            self.epsilon = math.cos(self.decay*self.trial_cnt)
